...
?><div class="bx_page">
	...
	<p>
		 Далее, если вы закончили выбирать товар, нажмите кнопку <b>Корзина</b>.
	</p>
	<p>
		 На странице <b>Корзина</b> будут перечислены все выбранные вами товары.
	</p>
	<p>
		 В поле <b>Количество</b> вы можете изменить количество товара для покупки.&nbsp;
	</p>
	<p>
		 В колонке <b>Действия</b> можно <b>удалить</b> товар из корзины
	</p>
	<p>
	</p>
	<p>
 <span style="color: #757575; font-family: 'Open Sans', 'Helvetica Neue', Arial, Helvetica, sans-serif; font-size: 30px; line-height: 1.1;">2. Оформление и подтверждение заказа</span>
	</p>
	<p>
