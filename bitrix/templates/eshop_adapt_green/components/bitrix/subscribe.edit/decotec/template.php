...
if( count($arResult["MESSAGE"]) > 0 ) {
	...
	<div id="sender-subscribe-response-cont" style="display: none;">
		<div class="bx_subscribe_response_container">
			<table>
				<tr>
					<td style="padding-right: 40px; padding-bottom: 0px;"><img src="/bitrix/components/decotec/sender.subscribe/templates/.default/images/icon-ok.png" alt=""></td>
					<td>
						<div style="font-size: 22px;">Спасибо!</div>
						<div style="font-size: 16px;">Подписка подтверждена.</div>
					</td>
				</tr>
			</table>
		</div>
